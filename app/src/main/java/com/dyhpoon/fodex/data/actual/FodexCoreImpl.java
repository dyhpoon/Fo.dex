...
import com.dyhpoon.fodex.data.actual.FodexContract.IndexImageEntry;
import com.dyhpoon.fodex.data.actual.FodexContract.ShareEntry;
import com.dyhpoon.fodex.data.actual.FodexContract.TagEntry;
import com.dyhpoon.fodex.data.actual.FodexContract.UnindexedImageEntry;
 ...
 */
public class FodexCoreImpl implements FodexCore {
    @Override
        ...
        if (cursor.moveToFirst()) {
            do {
                FodexItem item = new FodexItem(
                        ...
                        cursor.getLong(cursor.getColumnIndex(FodexContract.ImageEntry.COLUMN_IMAGE_ID)),
                        cursor.getLong(cursor.getColumnIndex(FodexContract.ImageEntry.COLUMN_IMAGE_DATE_TAKEN)),
                        cursor.getString(cursor.getColumnIndex(FodexContract.ImageEntry.COLUMN_IMAGE_DATA))
                );
                items.add(item);
            } while (cursor.moveToNext());
        }
